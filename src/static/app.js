document.addEventListener("DOMContentLoaded", () => {
  ...
  const difficultyLevels = {
    ...
    Intermediate: { label: "Intermediate", color: "#fff9c4", textColor: "#f57f17" },
    Advanced: { label: "Advanced", color: "#ffcdd2", textColor: "#c62828" },
  };
  ...
  function renderActivityCard(name, details) {
    ...
    if (details.difficulty && difficultyLevels[details.difficulty]) {
      ...
      difficultyHtml = `
        <span class="difficulty-badge" style="background-color: ${diffInfo.color}; color: ${diffInfo.textColor}">
          ${diffInfo.label}
        </span>
      `;
    }
